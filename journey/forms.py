...
class PostForm(forms.ModelForm):
    class Meta:
        model = Post
        fields = (
        'title', 'image_upload', 'image_url', 'visited_places', 'visited_date', 'favorite_place', 'address', 'favorite_activity', 'description')
...
class CreateUserAccountForm(UserCreationForm):
    nickname = forms.CharField(max_length=60, help_text='Required')
